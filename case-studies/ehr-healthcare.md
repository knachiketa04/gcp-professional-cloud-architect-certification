...
* **Existing Technical Environment:**  
  ...
  * They have **legacy on-premises file- and API-based integrations** with insurance providers, which are *not* slated for immediate upgrade or migration to the cloud.  
